...
<Image src={frame} alt="" class="mx-auto max-w-lg" />
...
<Image src={base} alt="" class="max-w-lg mx-auto" />
...
<Image src={grid} alt="" class="max-w-lg mx-auto"/>
...
<Image src={gridLeds} alt="" class="max-w-lg mx-auto"/>
