---
title: "Using OpenSCAD and FreeCAD"
...
(and what could possibly worth more passion than individually controlled RGB LEDs?).
We made a pixel art mirror that in the end looked like this:

[picture of pixel art mirror]

Apart from showing as a mirror this thing can also show a variety of cool effects, curtesy of [WLED](#).

[grid of effects].

This is both the story of how we made it, as well as a how-to guide if you wanna make your own. 
...
they should fit perfectly in the little markings on the plate (lengthwise, they are less thick than the markings)
